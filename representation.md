...
2. Bag of words: without order information; representation: a length N vector, N is size of vocabulary. Can be represented as Binary Matrix, Count Matrix or TF-IDF Matrix. Can from bag of words to bag of grams.
   ...
   1. TF-IDF - can create word-document matrix
      ...
      ![Untitled](img_rep/Untitled.png)

   2. PPMI - can create word-word matrix

   ![Untitled](img_rep/Untitled%201.png)
...
- word2vec[co-occurrence statistics], Local context window methods
  - CBoW: use a window to predict center word
    ![Untitled](img_rep/Untitled%202.png)
  - SkipGarm: use center word to predict surrounding words
    ![Untitled](img_rep/Untitled%203.png)
    - Structure:
...
- And then it introduces the GloVe:
  ...
  - Basic idea:
    ![Untitled](img_rep/Untitled%204.png)
    ...
    ![Untitled](img_rep/Untitled%205.png)
    ![Untitled](img_rep/Untitled%206.png)
    We can absorb log(_Xᵢ_) as a constant bias term since it is invariant of *k.*
  ...
  - Cost function: Mean Square Error to calculate the error in the ground truth and the predicted co-occurrence counts.
    ![Untitled](img_rep/Untitled%207.png)
...
- Two layer BiLSTM
  ![Untitled](img_rep/Untitled%208.png)
- Advantage
...
![Untitled](img_rep/Untitled%209.png)

![Untitled](img_rep/Untitled%2010.png)

![Untitled](img_rep/Untitled%2011.png)

![Untitled](img_rep/Untitled%2012.png)

![Untitled](img_rep/Untitled%2013.png)

![Untitled](img_rep/Untitled%2014.png)

![Untitled](img_rep/Untitled%2015.png)
